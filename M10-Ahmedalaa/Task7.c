...
{       //used char because it is 8 bits only
    ...
    printf("%d \n", var2); //just to check that var2 has the 6 left elements of var1 .... = 8    0000 1000

    var3 = var1 << 6; //shift right with 6    1000 0000 ... 128
    printf("%d \n", var3);

    var4 = var2 >> 2; //shift left with 2     0000 0010
